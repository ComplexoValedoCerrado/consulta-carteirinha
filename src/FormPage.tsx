  ...
  return (
    <>
      <div className='w-full h-[100dvh] flex flex-col'>
        {/* Área Principal - reduzida para caber o carrossel */}
        <div className='flex flex-col lg:flex-row w-full h-full bg-midnight-blue overflow-hidden'>
          {/* Coluna da Esquerda */}
          <div className='flex flex-col justify-center w-full lg:w-1/2 h-full px-4 py-6 lg:pl-16 xl:pl-24 2xl:pl-35'>
            <div className='flex flex-col gap-3 lg:gap-5 w-full max-w-2xl mx-auto lg:mx-0'>
            ...
            <hr className="border-b-3 border-blue-400 mt-3 w-full max-w-xl mx-auto lg:mx-0" />

            <form 
              className='flex flex-col items-center lg:items-start justify-center w-full max-w-xl mx-auto lg:mx-0 space-y-3 mt-3 px-4 lg:px-0' 
            ...
            >
              ...
              <div className='w-full sm:w-8/10 flex items-center justify-center lg:justify-start mt-3'>
                <button 
          ...
          <div className='hidden lg:flex flex-col justify-center items-center w-1/2 h-full'>
            <div className='relative w-full h-full'>
              <img 
                src={woman_image} 
                className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[80vh] w-auto object-contain'
                alt="Mulher sorrindo" 
                loading="eager"
              />
            </div>
